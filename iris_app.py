...
html_temp = """
	...
	<h1 style ="color:#f0f0f5; text-align:center; ">Streamlit Iris Flower Classifier by Han </h1>
	</div>
	"""
...
st.sidebar.title("_Hoş geldiniz , çiçekci değiliz burada bilim yapıyoruz. Please Enter the Features and Model Name to Predict the Species of Iris Flower_")
